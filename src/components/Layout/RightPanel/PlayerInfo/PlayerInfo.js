...
const PlayerInfo = (props) => {
  ...
  const playerInv = useSelector((state) =>
    state.items.itemsById.filter((item) => item.ownerId === 0)
  );
  const playerEquippedItemsByIds =
    playerInv.filter((item) => item.equipped) || [];
  ...
  const xpPercentage =
    Math.round((player.xp / player.xpToNextLevel) * 100) + '%';
  ...
  return (
    <div className={props.className}>
      ...
      <div className={styles.playerStatsAS}>
        <div className={styles.playerStatsAS__col_1}>
          <div className={styles.ASrow}>
            {player.levelsUpAvailable > 0 ? (
              <LevelUpStatIncreaseButton stat={'strength'} />
            ) : (
              ''
            )}
            <div>Strength: </div>
          ...
          <div className={styles.ASrow}>
            {player.levelsUpAvailable > 0 ? (
              <LevelUpStatIncreaseButton stat={'dexterity'} />
            ) : (
              ''
            )}
            <div>Dexterity: </div>
          ...
          <div className={styles.ASrow}>
            {player.levelsUpAvailable > 0 ? (
              <LevelUpStatIncreaseButton stat={'constitution'} />
            ) : (
              ''
            )}
            <div>Constitution: </div>
            <div>{player.constitution}</div>
          </div>
        </div>
        <div className={styles.playerStatsAS__col_2}>
          <div className={styles.ASrow}>
            {player.levelsUpAvailable > 0 ? (
              <LevelUpStatIncreaseButton stat={'charisma'} />
            ) : (
              ''
            )}
            <div>Charisma: </div>
            <div>{player.charisma}</div>
          </div>
          <div className={styles.ASrow}>
            {player.levelsUpAvailable > 0 ? (
              <LevelUpStatIncreaseButton stat={'wisdom'} />
            ) : (
              ''
            )}
            <div>Wisdom: </div>
            <div>{player.wisdom}</div>
          </div>
          <div className={styles.ASrow}>
            {player.levelsUpAvailable > 0 ? (
              <LevelUpStatIncreaseButton stat={'intelligence'} />
            ) : (
              ''
            )}
      ...
      <div className={styles.XPBar}>
        ...
        <div className={styles.xpNumeralsDisplay}>
          {player.xp} <div className={styles.horizontalLine} />{' '}
