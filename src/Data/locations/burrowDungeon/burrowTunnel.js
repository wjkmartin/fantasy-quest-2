const randomString = () => {
    switch (Math.floor(Math.random() * 6) || 1) {
      case 1:
        return 'The moist earth in the tunnel squelches under your feet, removing any artifice of stealth.';
      case 2:
      ...
      case 4:
        return 'There are long scratches in the walls here. It was either the goblins, or their victims. The latter gives you the chills.';
      case 5:
