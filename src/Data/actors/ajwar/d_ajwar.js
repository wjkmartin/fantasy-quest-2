...
export default {
  ...
  smappleQuest: {
    text: "Well I was mugged you see... by one of those damned pirates from the Red Moon! And they- th- they stole my magic smapple! My pride and joy! A one of a kind smapple... I need someone to get it back from those brigands.",
    buttons: [
  ...
  smappleQuest2: {
    text: "Thank you! Now make haste for the Red Moon and look for Pamina. And don't let her good looks fool you... she's a savage. She'll tear of yer ears and eat them if she gets a chance!",
    buttons: [
      {quitConvo: "I'll see you in a bit."}
    ],
    actionsOnShow: [function() {store.dispatch(actions.setQuestStage('aquireSmapple', 'stage0'))
    }]
  }
};
