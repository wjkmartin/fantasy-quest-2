...
export default function (state = initalState, action) {
  switch (action.type) {
    case 'SET_CURRENT_LOCATION_BY_ID': {
      return {
        ...state,
        currentLocation: Object.values(state.locations).find(
    ...
    case 'SET_MAP': {
      //Currently can only load top level locations
    ...
    case 'SET_HAS_AGGRESSIVE_ACTORS': {
      return {
        ...
        currentLocation: {
          ...
          hasAggressiveActors: action.flag,
        },
      }
    }
    case 'SET_IS_DISCOVERED': {
      return {
        ...
        locations: {
          ...state.locations,
          [action.locationId]: {
            ...state.locations[action.locationId],
            discovered: true,
          }
        }
      };
